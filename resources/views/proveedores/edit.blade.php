        ...
        <div class="col-md-10 col-lg-8 d-flex h-100">
            <div class="card flex-fill d-flex flex-column">
                <div class="card-header fondo-rojo">
                    <i class="bi bi-pencil"></i> {{ __('Editar Proveedor') }}
                </div>

                <div class="card-body overflow-auto flex-fill">
                    <form method="POST" action="{{ route('proveedores.update', $proveedor->uuid) }}" id="formProveedor">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-8 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('nombre') is-invalid @enderror" 
                                               id="nombre" name="nombre" value="{{ old('nombre', $proveedor->nombre) }}" required autofocus>
                                        @error('nombre')
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('cif') is-invalid @enderror" 
                                               id="cif" name="cif" value="{{ old('cif', $proveedor->cif) }}">
                                        @error('cif')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('contacto_principal') is-invalid @enderror" 
                                           id="contacto_principal" name="contacto_principal" value="{{ old('contacto_principal', $proveedor->contacto_principal) }}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('codigo_postal') is-invalid @enderror" 
                                               id="codigo_postal" name="codigo_postal" value="{{ old('codigo_postal', $proveedor->codigo_postal) }}">
                                        @error('codigo_postal')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="number" class="form-control @error('dias_pago') is-invalid @enderror" 
                                               id="dias_pago" name="dias_pago" value="{{ old('dias_pago', $proveedor->dias_pago) }}" min="0" max="365">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="number" class="form-control @error('descuento_general') is-invalid @enderror" 
                                               id="descuento_general" name="descuento_general" value="{{ old('descuento_general', $proveedor->descuento_general) }}" 
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('condiciones_pago') is-invalid @enderror" 
                                              id="condiciones_pago" name="condiciones_pago" rows="2">{{ old('condiciones_pago', $proveedor->condiciones_pago) }}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('cuenta_bancaria') is-invalid @enderror" 
                                           id="cuenta_bancaria" name="cuenta_bancaria" value="{{ old('cuenta_bancaria', $proveedor->cuenta_bancaria) }}" 
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('notas') is-invalid @enderror" 
                                              id="notas" name="notas" rows="3">{{ old('notas', $proveedor->notas) }}</textarea>
                                    @error('notas')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="activo" name="activo" 
                                           value="1" {{ old('activo', $proveedor->activo) ? 'checked' : '' }}>
...
<div class="card-footer">
    <div class="d-flex align-items-center justify-content-center gap-2">
        <a href="{{ route('proveedores.show', $proveedor->uuid) }}" class="btn btn-primary fondo-rojo borde-rojo">
